                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-300">info@healthcareconnect.com</p>
                    </div>
                  </div>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {[
              ...
              {
                question: "Is there a cost for patients to use the platform?",
                answer:
                  "We offer a basic free plan for patients with limited features. For full access to all features, we have affordable subscription plans starting at $29/month.",
              },
              {
                question: "Can I integrate the platform with my existing electronic health record (EHR) system?",
                answer:
                  "Yes, we offer integration with major EHR systems. Our enterprise plan includes custom integration services to ensure seamless connectivity with your existing systems.",
              },
            ].map((faq, index) => (
