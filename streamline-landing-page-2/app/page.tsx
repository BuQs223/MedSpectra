        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
              ...
              >
                <Image
                  src="/placeholder.svg?height=400&width=600&text=MedSpectra"
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-center text-slate-900 dark:text-white mb-2">Dr. Ionel A.</h3>
            ...
            >
              <div className="h-16 w-16 mx-auto mb-4 relative">
                <Image
                  src="/placeholder.svg?height=64&width=64&text=HIPAA"
